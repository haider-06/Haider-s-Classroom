...
export default function StudentDashboard() {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      {/* Sidebar */}
        <aside 
          className={`fixed top-0 left-0 h-full w-64 bg-gray-950 text-white border-r border-gray-800 
                   transition-all duration-300 ${sidebarCollapsed ? '-translate-x-full' : ''} 
                   z-50`}
      >
        <div className="flex h-16 items-center justify-between px-5 border-b border-white/10">
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-gray-900 ring-1 ring-white/10 text-lg font-semibold text-sky-300">
              S
            </div>
            <div>
          ...
          <button
            ...
            className="inline-flex h-10 w-10 items-center justify-center rounded-2xl bg-gray-900 text-gray-300 hover:bg-gray-800"
        ...
        <nav className="space-y-1 p-4">
          <a 
            ...
            className="group flex items-center gap-3 rounded-3xl px-4 py-3 text-sm font-medium text-gray-200 transition hover:bg-gray-800 hover:text-white"
          >
            <span className="inline-flex h-11 w-11 items-center justify-center rounded-2xl bg-gray-900 text-gray-300 transition group-hover:bg-gray-800">
      ...
      <main className={`flex-1 ${sidebarCollapsed ? 'pl-0' : 'pl-64'} 
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between mb-6">
          <div>
            ...
            <p className="text-gray-500">Here's your personalized dashboard to track your learning progress.</p>
          </div>
          <div className="flex items-center gap-3">
            <button 
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3 p-4 border-b border-gray-100">
              ...
              <span className="text-xs font-semibold text-primary">Grade: A</span>
            </div>
            ...
            <div className="flex items-center gap-3 p-4">
              ...
              <span className="text-xs font-semibold text-primary">Study materials available</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
            ...
            <div className="space-y-3">
              <a 
                href="/student/resources" 
                className="block w-full text-left px-4 py-3 rounded-lg hover:bg-gray-50 transition-colors border border-gray-100"
              >
                <div className="flex items-center justify-between">
